...
Source: https://developer.ninjatrader.com/docs/desktop/chartanchor
...
| **[Time](https://developer.ninjatrader.com/docs/desktop/chartanchor_time)** | Determines the date/time value the chart anchor is drawn. |
