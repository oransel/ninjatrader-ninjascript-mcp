...
Source: https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_brush
...
- For convenience, Direct2D provides the [BrushProperties](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_brushproperties) function for creating new a **Brush**.
