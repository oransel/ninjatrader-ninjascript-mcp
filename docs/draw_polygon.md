...
Source: https://developer.ninjatrader.com/docs/desktop/draw_polygon
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/draw_polygon#definition)


Draws a polygon which can have a user defined set of anchors.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/draw_polygon#method-return-value)


A **[Polygon](https://developer.ninjatrader.com/docs/desktop/polygon)** object that represents the draw object.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/draw_polygon#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/draw_polygon#parameters)
...
| areaBrush | The brush used to color draw object ([reference](https://developer.ninjatrader.com/docs/desktop/brushes)). |
| areaOpacity | Sets the level of transparency for the fill color. Valid values between 0 - 100. (0 = completely transparent, 100 = no opacity). |
| templateName | The name of the drawing tool template the object will use to determine various visual properties (empty string could be used to just use the UI default visuals instead). |


## [Examples](https://developer.ninjatrader.com/docs/desktop/draw_polygon#examples)
