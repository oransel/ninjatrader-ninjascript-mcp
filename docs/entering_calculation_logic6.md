...
Source: https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic6
...
## [Entering Calculation Logic](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic6#entering-calculation-logic)
...
## [Initializing the Indicator](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic6#initializing-the-indicator)
...
## [Adding Core Indicator Logic](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic6#adding-core-indicator-logic)
...
## [Custom Drawing](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic6#custom-drawing)
...
| --- | --- |
| [BackBrushes](https://developer.ninjatrader.com/docs/desktop/backbrushes) | A collection of Brushes used for chart background color at specific bar indexes |
| [BarBrushes](https://developer.ninjatrader.com/docs/desktop/barbrushes) | A collection of Brushes used to paint bars at specific indexes |
| [CandleOutlineBrushes](https://developer.ninjatrader.com/docs/desktop/candleoutlinebrushes) | A collection of Brushes used to paint candle outlines at specific indexes |


Now that everything is in place, your class code should look as below. You are now ready to [compile the indicator](https://developer.ninjatrader.com/docs/desktop/compiling6) and configure it on a chart.
