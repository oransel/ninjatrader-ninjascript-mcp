...
Source: https://developer.ninjatrader.com/docs/desktop/connectionstatuseventargs
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/connectionstatuseventargs#definition)


**ConnectionStatusEventArgs** contains **Connection**-related information to be passed as an argument to the **[OnConnectionStatusUpdate()](https://developer.ninjatrader.com/docs/desktop/onconnectionstatusupdate)** event.
![note image](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FNote.57c6078c.svg&w=64&q=75)

## Note


For a complete, working example of this class in use, download framework example located on our [Developing AddOns Overview](https://developer.ninjatrader.com/docs/desktop/addon_development_overview).
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/connectionstatuseventargs#examples)
