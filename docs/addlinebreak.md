...
Source: https://developer.ninjatrader.com/docs/desktop/addlinebreak
...
| baseBarsPeriodType | The underlying BarsType used for the LineBreak bars period. Possible values are:
