...
Source: https://developer.ninjatrader.com/docs/desktop/quantityupdown
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/quantityupdown#definition)


**QuantityUpDown** can be used as a UI element users can interact with for selecting quantity.


## [Events and Properties](https://developer.ninjatrader.com/docs/desktop/quantityupdown#events-and-properties)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/quantityupdown#examples)
