...
Source: https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_strokestyle
...
- A stroke style is a device-independent resource; you can create it once then retain it for the life of your application. Please see the [MSDN Direct2D Resources Overview](https://msdn.microsoft.com/en-us/library/dd756757(v=vs.85).aspx) for more information.
- For convenience, Direct2D provides the [StrokeStyleProperties](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_strokestyleproperties) function for creating new a StrokeStyle. |
