...
Source: https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic5
...
## [Setting Plot Thresholds](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic5#setting-plot-thresholds)
...
## [Completing the Indicator](https://developer.ninjatrader.com/docs/desktop/entering_calculation_logic5#completing-the-indicator)
...
The class code in your editor should look identical to the image below. You are now ready to [compile the indicator](https://developer.ninjatrader.com/docs/desktop/compiling) and configure it on a chart.
