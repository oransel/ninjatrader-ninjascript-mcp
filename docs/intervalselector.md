...
Source: https://developer.ninjatrader.com/docs/desktop/intervalselector
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/intervalselector#definition)
...
## [Events and Properties](https://developer.ninjatrader.com/docs/desktop/intervalselector#events-and-properties)


| Property | Description |
| --- | --- |
| **Cleanup()** | Disposes of the **IntervalSelector** (Note: calling the [**NTTabPage** base.**Cleanup()**](https://developer.ninjatrader.com/docs/desktop/cleanup) is sufficient to clean up this control) |
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/intervalselector#examples)
