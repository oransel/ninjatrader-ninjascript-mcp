...
Source: https://developer.ninjatrader.com/docs/desktop/debugging_your_ninjascript_code
...
Debugging orders can be a bit harder though because you cannot discern the behavior state of your orders through the **Print()** command easily. In addition to **Print()**, you can use [TraceOrders](https://developer.ninjatrader.com/docs/desktop/traceorders) to help you decipher what is happening under the hood for orders. [TraceOrders](https://developer.ninjatrader.com/docs/desktop/traceorders) will print information into the Output Window that will contain details about your orders.
...
When debugging stop or limit orders it can also be extremely useful to draw dots along your chart of the actual stop/limit prices. This way you can visually see where your orders are at and if they should have been filled or not. [Draw.Dot](https://developer.ninjatrader.com/docs/desktop/draw_dot)
