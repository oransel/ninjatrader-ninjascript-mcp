...
Source: https://developer.ninjatrader.com/docs/desktop/pricestatus
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/pricestatus#definition)


Indicates the current status of the price feed of the primary data connection


## [Syntax](https://developer.ninjatrader.com/docs/desktop/pricestatus#syntax)


`<connection>.PriceStatus`


## [Examples](https://developer.ninjatrader.com/docs/desktop/pricestatus#examples)
