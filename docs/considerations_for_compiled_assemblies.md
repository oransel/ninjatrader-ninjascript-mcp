...
Source: https://developer.ninjatrader.com/docs/desktop/considerations_for_compiled_assemblies
...
- Loop through your collection using the interface type
- Use **ToString()** to check the fully qualified namespace of the object in the loop
- Cast the object to **dynamic**, and reference properties of that object assuming it is the expected type
