...
Source: https://developer.ninjatrader.com/docs/desktop/order
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/order#definition)
...
- The property **<`order`>.OrderId** is NOT a unique value, since it can change throughout an order's lifetime. Please see the [Advance Order Handling](https://developer.ninjatrader.com/docs/desktop/advanced_order_handling) section on "Transitioning order references from historical to live" for details on how to handle.
...
## [Methods and Properties](https://developer.ninjatrader.com/docs/desktop/order#methods-and-properties)


| Parameter | Description |
| --- | --- |
| Account | The [Account](https://developer.ninjatrader.com/docs/desktop/account_class) the order resides |
...
| HasOverfill | A bool value representing if the order is an overfill. For use when using [Unmanaged orders](https://developer.ninjatrader.com/docs/desktop/unmanaged_approach) and [IgnoreOverFill](https://developer.ninjatrader.com/docs/desktop/ignoreoverfill) |
| Instrument | An [Instrument](https://developer.ninjatrader.com/docs/desktop/instrument) value representing the instrument of an order |
| IsBacktestOrder | A bool that indicates if the order was generated while processing historical data. For use with [GetRealtimeOrder()](https://developer.ninjatrader.com/docs/desktop/getrealtimeorder) when transitioning historical order objects to live order objects when strategies transition to from State.Historical to State.Realtime. |
| IsLiveUntilCancelled | A bool that when true, indicates the order will be canceled by [managed order handling](https://developer.ninjatrader.com/docs/desktop/managed_approach) at expiration |
...
| LimitPriceChanged | A double value representing the new limit price of an order. Used with [Account.Change()](https://developer.ninjatrader.com/docs/desktop/change) |
...
| QuantityChanged | An int value representing the new quantity of an order. Used with [Account.Change()](https://developer.ninjatrader.com/docs/desktop/change) |
| StopPrice | A double value representing the stop price of an order |
| StopPriceChanged | A double value representing the new stop price of an order. Used with [Account.Change()](https://developer.ninjatrader.com/docs/desktop/change) |
...
## [OrderState Values](https://developer.ninjatrader.com/docs/desktop/order#orderstate-values)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/order#examples)
