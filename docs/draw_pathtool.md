...
Source: https://developer.ninjatrader.com/docs/desktop/draw_pathtool
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/draw_pathtool#definition)


Draws a path which can have a user defined set of anchors.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/draw_pathtool#method-return-value)


A **[PathTool](https://developer.ninjatrader.com/docs/desktop/pathtool)** object that represents the draw object.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/draw_pathtool#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/draw_pathtool#parameters)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/draw_pathtool#examples)
