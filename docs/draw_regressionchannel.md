...
Source: https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel#definition)


Draws a regression channel.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel#method-return-value)


A **[RegressionChannel](https://developer.ninjatrader.com/docs/desktop/regressionchannel)** object that represents the draw object.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel#parameters)
...
| upperBrush, middleBrush, lowerBrush | The line colors ([reference](https://developer.ninjatrader.com/docs/desktop/brushes)). |
| upperWidth, middleWidth, lowerWidth | The line width. |
| isGlobal | Determines if the draw object will be global across all charts which match the instrument. |
| templateName | The name of the drawing tool template the object will use to determine various visual properties (empty string could be used to just use the UI default visuals instead). |


## [Examples](https://developer.ninjatrader.com/docs/desktop/draw_regressionchannel#examples)
