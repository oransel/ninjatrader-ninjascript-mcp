...
Source: https://developer.ninjatrader.com/docs/desktop/getdaybar
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/getdaybar#definition)
...
- **GetDayBar()** should ONLY be used for accessing prior trading day data. To access current trading day data, use the **CurrentDayOHL()** method.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/getdaybar#method-return-value)


A virtual bar object representing the current configured session. Otherwise null if there is insufficient intraday data.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/getdaybar#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/getdaybar#parameters)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/getdaybar#examples)
