...
Source: https://developer.ninjatrader.com/docs/desktop/pathtool
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/pathtool#definition)


Represents an interface that exposes information regarding a PathTool **IDrawingTool**.


## [Methods and Properties](https://developer.ninjatrader.com/docs/desktop/pathtool#methods-and-properties)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/pathtool#examples)
