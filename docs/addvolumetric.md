...
Source: https://developer.ninjatrader.com/docs/desktop/addvolumetric
...
- To access additional Volumetric data points programmtically in your NinjaScript studies, please see the example [here](https://developer.ninjatrader.com/docs/desktop/order_flow_volumetric_bars).
