...
Source: https://developer.ninjatrader.com/docs/desktop/entering_strategy_logic
...
## [Using the **OnStateChange()** Method to Configure the Strategy](https://developer.ninjatrader.com/docs/desktop/entering_strategy_logic#using-the-method-to-configure-the-strategy)
...
For more information on the strategy properties added in State.SetDefaults, please see our complete [Strategy](https://developer.ninjatrader.com/docs/desktop/strategy) documentation.
...
## [Using the **OnBarUpdate()** Method for the Core Strategy Logic](https://developer.ninjatrader.com/docs/desktop/entering_strategy_logic#using-the-method-for-the-core-strategy-logic)
