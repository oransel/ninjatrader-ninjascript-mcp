...
Source: https://developer.ninjatrader.com/docs/desktop/tifselector
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/tifselector#definition)


**TifSelector** can be used as a UI element users can interact with for selecting TIF.


## [Events and Properties](https://developer.ninjatrader.com/docs/desktop/tifselector#events-and-properties)


| Method/Property | Description |
| --- | --- |
| **Cleanup()** | Disposes of the **TifSelector** (Note: calling the [NTTabPage base.Cleanup()](https://developer.ninjatrader.com/docs/desktop/cleanup) is sufficient to clean up this control) |
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/tifselector#examples)
