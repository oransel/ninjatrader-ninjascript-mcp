...
Source: https://developer.ninjatrader.com/docs/desktop/onexecutionupdate
...
| **marketPosition** | A [**MarketPosition**](https://developer.ninjatrader.com/docs/desktop/marketposition) object representing the position of the execution. Possible values are:
