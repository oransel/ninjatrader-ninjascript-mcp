...
Source: https://developer.ninjatrader.com/docs/desktop/numberrestartattempts
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/numberrestartattempts#definition)
...
## [Property Value](https://developer.ninjatrader.com/docs/desktop/numberrestartattempts#property-value)


An **int** value represents the maximum number of restart attempts. Default value is set to 4.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/numberrestartattempts#syntax)


`NumberRestartAttempts`


## [Examples](https://developer.ninjatrader.com/docs/desktop/numberrestartattempts#examples)
