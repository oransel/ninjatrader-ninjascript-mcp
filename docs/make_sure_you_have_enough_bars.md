...
Source: https://developer.ninjatrader.com/docs/desktop/make_sure_you_have_enough_bars
...
The resolution above would be used in a [Multi Time Frame](https://developer.ninjatrader.com/docs/desktop/multi_time_frame_instruments) script. Since **OnBarUpdate()** processes multiple data series, we need to make sure each Data Series we reference has processed enough bars.
