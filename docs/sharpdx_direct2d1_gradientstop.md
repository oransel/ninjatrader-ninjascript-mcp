...
Source: https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_gradientstop
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_gradientstop#definition)
...
## [Notes](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_gradientstop#notes)
...
## [Syntax](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_gradientstop#syntax)


`struct GradientStop`


## [Properties](https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_gradientstop#properties)


| Position | Color |
| --- | --- |
| A float value that indicates the relative position of the gradient stop in the brush. This value must be in the [0.0f, 1.0f] range if the gradient stop is to be seen explicitly. | The [SharpDX.Color](https://developer.ninjatrader.com/docs/desktop/sharpdx_color) of the gradient stop. |
