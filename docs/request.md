...
Source: https://developer.ninjatrader.com/docs/desktop/request
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/request#definition)


Performs the bars request for a **BarsRequest** object


## [Syntax](https://developer.ninjatrader.com/docs/desktop/request#syntax)


`BarsRequest.Request(Action<barsrequest, errorcode, string> callback)`


## [Properties](https://developer.ninjatrader.com/docs/desktop/request#properties)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/request#examples)
