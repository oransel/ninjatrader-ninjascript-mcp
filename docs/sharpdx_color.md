...
Source: https://developer.ninjatrader.com/docs/desktop/sharpdx_color
...
- Named colors are represented by using the properties of the Color structure. Please see the table of Static Named Colors below.
