...
Source: https://developer.ninjatrader.com/docs/desktop/draw_region
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/draw_region#definition)


Draws a region on a chart.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/draw_region#method-return-value)


A **[Region](https://developer.ninjatrader.com/docs/desktop/region)** object that represents the draw object.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/draw_region#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/draw_region#parameters)
...
| displacement | An optional parameter which will offset the barsAgo value for the **Series<`double`>** value used to match the desired [Displacement](https://developer.ninjatrader.com/docs/desktop/displacement). Default value is 0. |


## [Examples](https://developer.ninjatrader.com/docs/desktop/draw_region#examples)
...
## [Tips](https://developer.ninjatrader.com/docs/desktop/draw_region#tips)
