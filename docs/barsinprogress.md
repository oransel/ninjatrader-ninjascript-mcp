...
Source: https://developer.ninjatrader.com/docs/desktop/barsinprogress
...
- See additional information on running [multi-bars scripts](https://developer.ninjatrader.com/docs/desktop/multi_time_frame_instruments).
