...
Source: https://developer.ninjatrader.com/docs/desktop/adding_indicators_to_strategies
...
To add a volume indicator to your charts you need to add this code snippet into the [OnStateChange](https://developer.ninjatrader.com/docs/desktop/onstatechange) section of your code for the State: State.DataLoaded
...
Remember, you need to use the [AddChartIndicator()](https://developer.ninjatrader.com/docs/desktop/addchartindicator) method to add your indicator if you wish to use any of the plot / line indicator customization examples.
