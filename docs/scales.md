...
Source: https://developer.ninjatrader.com/docs/desktop/scales
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/scales#definition)


A collection of **ChartScale** objects corresponding to objects within the chart panel.


## [Property Value](https://developer.ninjatrader.com/docs/desktop/scales#property-value)


A **ChartScaleCollection** containing **ChartScale** objects


## [Syntax](https://developer.ninjatrader.com/docs/desktop/scales#syntax)


`ChartPanel.Scales`


## [Examples](https://developer.ninjatrader.com/docs/desktop/scales#examples)
