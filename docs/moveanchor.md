...
Source: https://developer.ninjatrader.com/docs/desktop/moveanchor
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/moveanchor#definition)


Moves a Chart Anchor's x and y values from start point by a delta point amount.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/moveanchor#method-return-value)


This method does not return a value.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/moveanchor#syntax)
...
## [Method Parameters](https://developer.ninjatrader.com/docs/desktop/moveanchor#method-parameters)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/moveanchor#examples)
