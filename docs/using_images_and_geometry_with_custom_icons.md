...
Source: https://developer.ninjatrader.com/docs/desktop/using_images_and_geometry_with_custom_icons
...
- Instantiate a new BitmapImage object
- Assign a Uri to the BitmapImage, pointing to an image file
- Instantiate a Grid of the same dimensions as the icon
- Instantiate an Image object
- Assign the BitmapImage as the Image's Source
- Add the Image to the Grid
- Return the Grid by overriding the Icon property
...
- Instantiate a Grid of the same dimensions as the icon
- Define the visual properties of the Path
