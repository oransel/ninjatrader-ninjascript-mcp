...
Source: https://developer.ninjatrader.com/docs/desktop/set_up11
...
## [Defining Input Parameters](https://developer.ninjatrader.com/docs/desktop/set_up11#defining-input-parameters)
...
- Press the "Generate" button to generate the code in the NinjaScript Editor.
