...
Source: https://developer.ninjatrader.com/docs/desktop/connect
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/connect#definition)


Connects to a connection.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/connect#syntax)


`Connection.Connect(ConnectOptions options)`


## [Parameters](https://developer.ninjatrader.com/docs/desktop/connect#parameters)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/connect#examples)
