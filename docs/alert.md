...
Source: https://developer.ninjatrader.com/docs/desktop/alert
...
- This method can only be called once the [State](https://developer.ninjatrader.com/docs/desktop/state) has reached State.Realtime. Calls to this method in any other State will be silently ignored.
- For add-ons, please see the [AlertCallback()](https://developer.ninjatrader.com/docs/desktop/alertcallback) method.
