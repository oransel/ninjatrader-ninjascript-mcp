...
Source: https://developer.ninjatrader.com/docs/desktop/startatmstrategy
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/startatmstrategy#definition)


**StartAtmStrategy** can be used to submit entry orders with ATM strategies.


## [Syntax](https://developer.ninjatrader.com/docs/desktop/startatmstrategy#syntax)
...
## [Properties](https://developer.ninjatrader.com/docs/desktop/startatmstrategy#properties)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/startatmstrategy#examples)
