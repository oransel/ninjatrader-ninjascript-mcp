...
Source: https://developer.ninjatrader.com/docs/desktop/connectionlosshandling
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/connectionlosshandling#definition)
...
- If data feed disconnects for longer than the time specified in [DisconnectDelaySeconds](https://developer.ninjatrader.com/docs/desktop/disconnectdelayseconds), the strategy is stopped.
...
## [Property Value](https://developer.ninjatrader.com/docs/desktop/connectionlosshandling#property-value)
...
| **ConnectionLossHandling.StopStrategy** | Automatically stops the strategy when disconnected for more than [DisconnectDelaySeconds](https://developer.ninjatrader.com/docs/desktop/disconnectdelayseconds). No action will be taken when a connection is reestablished. |


## [Syntax](https://developer.ninjatrader.com/docs/desktop/connectionlosshandling#syntax)


`ConnectionLossHandling`


## [Examples](https://developer.ninjatrader.com/docs/desktop/connectionlosshandling#examples)
