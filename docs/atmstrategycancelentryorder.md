...
Source: https://developer.ninjatrader.com/docs/desktop/atmstrategycancelentryorder
...
- This method is intended ONLY for orders submitted as [Atm Entry Orders](https://developer.ninjatrader.com/docs/desktop/atmstrategycreate) and assumes the [OrderState](https://developer.ninjatrader.com/docs/desktop/getatmstrategyentryorderstatus) is NOT terminal (i.e., Cancelled, Filled, Rejected, Unknown).
