...
Source: https://developer.ninjatrader.com/docs/desktop/sharpdx_direct2d1_geometrysink
...
- To create a GeometrySink, describe a **PathGeometry** and retrieve the object using the **PathGeometry.Open()** method.
