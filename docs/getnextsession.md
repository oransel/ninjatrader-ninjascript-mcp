...
Source: https://developer.ninjatrader.com/docs/desktop/getnextsession
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/getnextsession#definition)
...
## [Property Value](https://developer.ninjatrader.com/docs/desktop/getnextsession#property-value)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/getnextsession#parameters)


| --- |
| timeLocal | includesEndTimeStamp |
...
## [Syntax](https://developer.ninjatrader.com/docs/desktop/getnextsession#syntax)


`<sessioniterator>.GetNextSession(DateTime timeLocal, bool includesEndTimeStamp)`


## [Examples](https://developer.ninjatrader.com/docs/desktop/getnextsession#examples)
