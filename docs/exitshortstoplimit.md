...
Source: https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#definition)


Generates a buy to cover stop limit order to exit a short position.


## [Method Return Value](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#method-return-value)
...
## [Syntax](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#parameters)
...
## [Examples](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#examples)
...
## [Tips (also see [Overview](https://developer.ninjatrader.com/docs/desktop/managed_approach))](https://developer.ninjatrader.com/docs/desktop/exitshortstoplimit#tips-(also-see-))
