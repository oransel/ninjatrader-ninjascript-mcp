...
Source: https://developer.ninjatrader.com/docs/desktop/other_uses_for_an_addon
...
| Method | Description |
| --- | --- |
| <`account`>.[AccountItemUpdate](https://developer.ninjatrader.com/docs/desktop/accountitemupdate) | Triggers on account item updates |
| <`account`>.[ExecutionUpdate](https://developer.ninjatrader.com/docs/desktop/executionupdate) | Triggers on any execution |
| <`account`>.[OrderUpdate](https://developer.ninjatrader.com/docs/desktop/orderupdate) | Triggers on any order state changes |
| <`account`>.[PositionUpdate](https://developer.ninjatrader.com/docs/desktop/positionupdate) | Triggers on any position updates |
...
## [Accessing Market Data](https://developer.ninjatrader.com/docs/desktop/other_uses_for_an_addon#accessing-market-data)
