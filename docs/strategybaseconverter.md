...
Source: https://developer.ninjatrader.com/docs/desktop/strategybaseconverter
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/strategybaseconverter#definition)
...
- See also [TypeConverterAttribute](https://developer.ninjatrader.com/docs/desktop/typeconverterattribute)
- For Indicators, see the [IndicatorBaseConverter](https://developer.ninjatrader.com/docs/desktop/indicatorbaseconverter) class


## [Relevant base methods](https://developer.ninjatrader.com/docs/desktop/strategybaseconverter#relevant-base-methods)
...
## [Syntax](https://developer.ninjatrader.com/docs/desktop/strategybaseconverter#syntax)
...
Tip: Common strategy functions like `Print()` are not available to a type converter instance. To debug a type converter class, you can use the AddOn [Debug Concepts](https://developer.ninjatrader.com/docs/desktop/alert_and_debug_concepts) or [attach to a debugger](https://developer.ninjatrader.com/docs/desktop/visual_studio_debugging) (recommended)


## [Examples](https://developer.ninjatrader.com/docs/desktop/strategybaseconverter#examples)
