...
Source: https://developer.ninjatrader.com/docs/desktop/categoryorderattribute
...
## [Definition](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#definition)
...
## [NinjaScript Indicators](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#ninjascript-indicators)
...
## [NinjaScript Strategies](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#ninjascript-strategies)
...
## [Syntax](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#syntax)
...
## [Parameters](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#parameters)


| category | A string identifying the **GroupName** to be categorized |
| --- | --- |
| order | An int determining the sequence the Category displays |


## [Examples](https://developer.ninjatrader.com/docs/desktop/categoryorderattribute#examples)
